...
def generate_figures():
    ...
    cold_patch = mpatches.Patch(color=COLD_COLOR, label='Cold-active Enzyme (Class 0)')
    warm_patch = mpatches.Patch(color=WARM_COLOR, label='Mesophilic Enzyme (Class 1)')
